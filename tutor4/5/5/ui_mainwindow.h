...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupBox->setGeometry(QRect(30, 20, 231, 101));
        widget = new QWidget(groupBox);
        widget->setObjectName(QStringLiteral("widget"));
        widget->setGeometry(QRect(30, 30, 184, 52));
        ...
        login1 = new QLineEdit(widget);
        login1->setObjectName(QStringLiteral("login1"));

        horizontalLayout->addWidget(login1);
        ...
        pass1 = new QLineEdit(widget);
        pass1->setObjectName(QStringLiteral("pass1"));

        horizontalLayout_2->addWidget(pass1);
